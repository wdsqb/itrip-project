 ...
 * 区域字典表
 */
@ApiModel(value = "com-hzl-entiy-AreaDic")
@Data
@Builder
...
public class AreaDic implements Serializable {
    ...
    private static final long serialVersionUID = -4818899720637021064L;

    public static AreaDicBuilder builder() {
        return new AreaDicBuilder();
    }
}