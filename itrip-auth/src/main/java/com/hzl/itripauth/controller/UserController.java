...
public class UserController {
    ...
    @ApiOperation(value = "用户名验证", httpMethod = "GET",
            produces = "HTTP", protocols = "application/json",
            response = ReturnResult.class, notes = "验证用户名是否存在")
    @GetMapping(value = "/ckusr")
    public ReturnResult checkUser(@ApiParam(name = "name",value = "待检验用户名") String name) {
